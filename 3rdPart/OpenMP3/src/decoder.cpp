...
void OpenMP3::Reservoir::SetPosition(UInt bit_pos)
{
...
OpenMP3::UInt OpenMP3::Reservoir::ReadBits(UInt n)	//number_of_bits to read(max 24).  bits are returned in the LSB of the return value
{
	hack_bits_read += n;
